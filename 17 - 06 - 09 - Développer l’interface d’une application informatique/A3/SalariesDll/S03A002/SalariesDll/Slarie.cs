...
namespace SalariesDll
{
    ...
    public class Salarie
    {
        ...
        {
            _compteurInstances++;
            OnNouvelleInstance(null, new SalarieNbInstanceEventArg(_compteurInstances));
        }
        ...
        public decimal SalaireBrut
        {
            ...
            {
                decimal tx;
                if (_salaireBrut > 0) tx = (value - _salaireBrut) / _salaireBrut * 100;
                else tx = 0;

                ChangementSalaire(this, new SalarieChangementSalaireEventArgs(_salaireBrut, tx));
        ...
        #region Evènements
        public event EventHandler<SalarieChangementSalaireEventArgs> OnChangementSalaire;
        static public EventHandler<SalarieNbInstanceEventArg> NouvelleInstance;
        protected virtual void ChangementSalaire(object sender, SalarieChangementSalaireEventArgs e)
        {
            if (OnChangementSalaire != null) OnChangementSalaire(sender, e);
        }
        static void OnNouvelleInstance(object sender, SalarieNbInstanceEventArg e)
        {
            if (NouvelleInstance != null) NouvelleInstance(sender, e);
        }
        #endregion
    }

    public class SalarieChangementSalaireEventArgs : EventArgs
    {
        private decimal _ancienSalaire;
        private decimal _txAugmentation;

        public SalarieChangementSalaireEventArgs(decimal ancienSalaire, decimal tauxAugmentation)
        {
            _ancienSalaire = ancienSalaire;
            _txAugmentation = tauxAugmentation;
        }
        public decimal AncienSalaire
        {
            get { return this._ancienSalaire;  }
            set { this._ancienSalaire = value; }
        }
        public decimal TauxAugmentation
        {
            get { return this._txAugmentation; }
            set { this._txAugmentation = value; }
        }
    }

    public class SalarieNbInstanceEventArg : EventArgs
    {
        int _nbInstances;
        public SalarieNbInstanceEventArg(int nbInstances)
        {
            _nbInstances = nbInstances;
        }
        public int NombreInstances
        {
            get { return _nbInstances; }
        }
